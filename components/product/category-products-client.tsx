...
export function CategoryProductsClient({ initialProducts, categoryName }: CategoryProductsClientProps) {
    ...
    <div className="space-y-6">
      ...
      {sortedProducts.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground mb-8">Check back later for new products in {categoryName}.</p>
          <Button asChild>
